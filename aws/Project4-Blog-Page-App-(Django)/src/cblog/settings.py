...
DATABASES = {
    'default': {
        ...
        'NAME': 'testDB', # database name in RDS is written here
...
AWS_STORAGE_BUCKET_NAME = 'cloudevops.link' # please enter your s3 bucket name
AWS_S3_CUSTOM_DOMAIN = '%s.s3.amazonaws.com' % AWS_STORAGE_BUCKET_NAME
AWS_S3_REGION_NAME = "US East (N. Virginia) us-east-1" # please enter your s3 region 
